...
echo "logvol swap --hibernation --fstype=swap --vgname=vg_$disk --label=swap --name=lv_swap" >> $file
echo "logvol none --vgname=vg_$disk --thinpool --profile=thin-performance --grow --name=lv_$disk" >> $file
