...
echo "logvol / --vgname=vg_$disk --name=lv_root --fstype=ext4 --size=8000 --thin --poolname=lv_$disk" >> $file
echo "logvol /home --vgname=vg_$disk --name=lv_home --fstype=ext4 --size=2000 --thin --poolname=lv_$disk" >> $file
echo "logvol /var --vgname=vg_$disk --name=lv_var --fstype=ext4 --size=10000 --thin --poolname=lv_$disk" >> $file
