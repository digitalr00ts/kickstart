...
echo "logvol none --vgname=vg_$disk --name=lv_$disk --thinpool --size=5000 --grow" >> $file
echo "logvol / --vgname=vg_$disk --name=lv_root --size=2000 --thin --poolname=lv_$disk" >> $file
echo "logvol /var --vgname=vg_$disk --name=lv_var --size=1000 --thin --poolname=lv_$disk" >> $file
